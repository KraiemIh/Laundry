...
})->withoutMiddleware([\App\Http\Middleware\InstalledMiddleware::class]);



// Other routes that need the full 'web' middleware group
...
Route::group(['middleware' => [\App\Http\Middleware\InstalledMiddleware::class]], function () {
    ...
    Route::group(['prefix' => 'admin', 'middleware' => [Store::class]], function () {
       ...
       /* Route::get('/test-event', function () {
            event(new OrderCreated('Une nouvelle commande a été ajoutée !'));
            return 'Événement envoyé !';
        });*/
        ...
        Route::group(['prefix' => 'orders/'], function () {
            Route::get('/woocommerce', \App\Livewire\WooCommerceOrders::class)->name('orders.woocommerce');
