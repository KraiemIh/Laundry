...
{
    public $services, $search_query, $order_id, $inputs = [], $selservices = [], $customer, $date, $delivery_date,$delivery_time, $discount, $paid_amount, $payment_type = 1;
    ...
    public function mount($id = null)
    {
        ...
        $this->delivery_time = Carbon::now()->format('H:i'); // Heure actuelle par défaut
        ...
        if($id)
        {
            ...
            $this->delivery_time = Carbon::parse($this->order->delivery_date)->format('H:i'); // Heure extraite de la date de livraison
